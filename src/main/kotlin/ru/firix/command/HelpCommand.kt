...
class HelpCommand: BotCommand("/help", "description of bot") {
    override fun execute(sender: AbsSender, user: User, chat: Chat, arguments: Array<out String>) {
        sendMessage(sender, chat.id, """
            |Hello, I am Agile Poker Bot and i help you estimate your tasks.
            ...
            |/delete - delete all users from lobby.
            ...
            | 
            |User chat commands:
            |/start - add user into Agile Poker Bot system.
            | 
            |You can find project on https://github.com/Firix-Pavel/AgilePokerBot.
            """.trimMargin()
        )
    }
}